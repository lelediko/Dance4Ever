...
<body>
	...
	<div class="login">
		...
		<form method="post" action="register">
			<input type="text" name="danceTeamName" placeholder="舞团名" required="required" />
			<input type="password" name="danceTeamPassword" placeholder="密码" required="required" />
			<input type="rpassword" name="rdanceTeamPassword" placeholder="确认密码" required="required" />
