...
<body scroll=auto>
 <div class="users">
 	<div align="center">
		<font color="white" size="6" >个人信息</font>
	</div>
	<div align="center">
		<form action="updateUserMessage" name = "form1" id = "form1" method="post">
			...
			<input type="text" name="danceTeamName" placeholder="所属舞团" value="舞团:${dt.danceTeamName }" /><br>
			<input type="text" name="roleNote" placeholder="舞团职位" value="${role.roleNote }" /><br>
